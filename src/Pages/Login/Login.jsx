          ...
          <div className="md:max-w-md w-full sm:px-6 py-4">
            <form>
              <div className="mb-12">
                ...
                <p className="text-sm mt-4 ">Don&apos;t have an account <Link to='/register'>
                <span href="javascript:void(0);" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</span></Link></p>
              </div>
              <div>
